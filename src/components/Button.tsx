...
const Button = (
    props: {
        variant: "primary" | "secondary" | "text" | "download";
        iconAfter?: ReactNode;
    ...
    return (
        <button className={twMerge(
            "h-11 px-6 rounded-xl border border-red-orange-500 uppercase inline-flex items-center gap-2 transition duration-700 relative group/button",
